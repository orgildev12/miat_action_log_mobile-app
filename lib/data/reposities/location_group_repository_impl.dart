...
class LocationGroupRepositoryImpl implements LocationGroupRepository {
  ...
  Future<List<LocationGroup>> fetchLocationGroups() async {
    try{
      ...
      final List<LocationGroupModel> remoteModels = await remote.fetchLocationGroups();
      await local.saveLocationGroups(remoteModels);
  ...
  @override
  Future<void> clearLocationGroupCache() async {
    try {
      await local.clearLocationGroups();
    } catch (e) {
      rethrow;
    }
  }
